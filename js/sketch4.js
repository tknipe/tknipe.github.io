...
function setup() {
    ...
    slider1 = createSlider(24, 384, 100);
...
function draw() {
    ...
    var palette = pals2[floor(random()*pals2.length)]
    ...
    } else if (txtsize > 148 && txtsize <= 196) {powfac = 2; powlac = -6;
    } else if (txtsize > 196 && txtsize <= 256) { powfac = 2; powlac = -7;
    } else if (txtsize > 256 && txtsize <= 320) { powfac = 2; powlac = -7;
    } else if (txtsize > 320 && txtsize <= 384) { powfac = 1; powlac = -8;
    } 
